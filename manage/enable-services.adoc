...
sidebar: sidebar 
keywords:  
summary: 'Você pode habilitar serviços opcionais como o provedor VASA, a importação de vVols configuração e a recuperação de desastres (SRA) usando ONTAP tools Manager.' 
---
...
. Na seção *Serviços*, você pode habilitar serviços opcionais como o provedor VASA, a importação da configuração do vVols e a recuperação de desastres (SRA), conforme necessário.
+
