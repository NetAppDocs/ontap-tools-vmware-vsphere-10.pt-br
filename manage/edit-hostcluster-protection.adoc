...
summary: Você pode editar os relacionamentos do SnapMirror do cluster de hosts protegidos. Você pode adicionar, modificar e excluir os relacionamentos. No entanto, não é possível editar o nome do grupo de consistência. 
---
= Modificar um cluster de hosts protegido nas ferramentas ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
