...
summary: Encerre sua implantação do ONTAP tools for VMware vSphere de forma adequada. 
---
= Desinstale sua implantação do ONTAP tools for VMware vSphere
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
A desinstalação das ONTAP tools for VMware vSphere exclui todos os dados nas ferramentas, portanto, você deve concluir estas etapas para encerrar sua implantação corretamente e evitar perda de dados.
...
** Para movê-los para um datastore não gerenciado, consulte  https://techdocs.broadcom.com/["Documentação técnica Broadcom"] para migrar máquinas virtuais com Storage vMotion
