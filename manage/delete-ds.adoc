...
summary: 'A ação "Excluir datastore" exclui o datastore. No caso de um datastore NFS ou VMFS, uma caixa de diálogo é exibida com a lista de máquinas virtuais que estão usando o datastore.' 
---
