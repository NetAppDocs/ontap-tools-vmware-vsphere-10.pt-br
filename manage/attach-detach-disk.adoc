...
summary: Conecte ou desconecte discos de dados de máquinas virtuais para gerenciar a capacidade de storage. 
---
= Anexar ou desanexar um disco de dados de uma VM nas ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
