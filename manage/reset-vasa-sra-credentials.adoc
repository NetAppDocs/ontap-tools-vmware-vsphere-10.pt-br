...
summary: Redefina as credenciais do VASA Provider e do SRA usando o ONTAP tools Manager quando você esquecer suas senhas. 
---
= Redefina as credenciais do VASA Provider e do SRA nas ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
