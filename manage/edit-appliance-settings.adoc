...
---
= Alterar as configurações do appliance ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
Certifique-se de que cada host ESXi contenha apenas uma VM do ONTAP tools. As entradas são validadas sempre que você avança para a próxima janela.
