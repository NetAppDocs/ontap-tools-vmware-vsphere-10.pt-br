...
summary: Habilite o acesso SSH para o usuário diag em ONTAP tools for VMware vSphere. 
---
= Configure o acesso remoto para diagnóstico das ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** O tempo expira.
+
A sessão de login expira à meia-noite do dia seguinte.
