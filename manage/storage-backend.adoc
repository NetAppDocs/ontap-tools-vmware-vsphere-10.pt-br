...
. Na página atalhos, selecione *Ferramentas do NetApp ONTAP* na seção plug-ins.
. No painel esquerdo das ferramentas ONTAP , vá para *Backends de armazenamento* e selecione um backend de armazenamento.
. Selecione o menu de reticências verticais e escolha *Remover*. Certifique-se de que o backend de storage não contenha nenhum datastore. Você pode acompanhar o progresso no painel de tarefas recentes.
