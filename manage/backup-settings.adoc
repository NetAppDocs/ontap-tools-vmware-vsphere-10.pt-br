...
summary: Ative ou desative o backup das ONTAP tools e configure a frequência de backup entre 10 e 60 minutos. 
---
= Editar configurações de backup das ferramentas ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
