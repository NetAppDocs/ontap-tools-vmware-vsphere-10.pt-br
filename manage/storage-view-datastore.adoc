...
summary: A visualização de armazenamento ONTAP na guia Configurar das ONTAP tools for VMware vSphere fornece dados relacionados ao datastore e seus volumes. 
---
