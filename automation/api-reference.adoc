...
---
= Referência da API REST das ONTAP tools
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.Passos
. Digite o seguinte URL no seu navegador, substituindo a combinação apropriada de endereço IP e porta pela variável, e pressione *Enter*.
+
`\https://$FQDN_IP_PORT/`
