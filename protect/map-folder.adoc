...
sidebar: sidebar 
keywords: folder mappings, protected and recovery sites, VMware Live Site Recovery, disaster recovery, ONTAP tools 
summary: Mapeie pastas entre sites protegidos e de recuperação para preparar fluxos de trabalho de failover do VMware Live Site Recovery. 
---
= Configure o mapeamento de pastas nas ferramentas ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Resultado
A página Mapeamento de Pastas exibe os recursos do site protegido e os recursos do site de recuperação. Você pode seguir os mesmos passos para outras pastas em seu ambiente.
