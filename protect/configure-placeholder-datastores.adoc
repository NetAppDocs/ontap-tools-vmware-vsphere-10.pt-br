...
sidebar: sidebar 
keywords: placeholder datastore, VMware Live Site Recovery, vCenter inventory, protected virtual machines, ONTAP tools 
summary: Configure datastores provisórios no site de recuperação para reservar espaço de inventário do vCenter para máquinas virtuais protegidas. 
---
= Configure armazenamentos de dados de espaço reservado nas ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
