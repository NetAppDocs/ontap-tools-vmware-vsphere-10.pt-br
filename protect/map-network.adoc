...
summary: Mapeie as redes entre os sites protegidos e de recuperação para alinhar a conectividade das máquinas virtuais durante o failover do VMware Live Site Recovery. 
---
= Configure os mapeamentos de rede nas ferramentas ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
