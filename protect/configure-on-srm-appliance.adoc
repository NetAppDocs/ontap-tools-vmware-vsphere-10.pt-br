...
sidebar: sidebar 
keywords: SRA configuration, VMware Live Site Recovery, ONTAP tools, disaster recovery, Site Recovery Manager appliance 
summary: Configure o SRA no appliance VMware Live Site Recovery para habilitar fluxos de trabalho de recuperação de desastres com ONTAP tools. 
---
= Configure o SRA no appliance VMware Live Site Recovery usando as ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Habilite os serviços SRA no ONTAP tools Manager. Para obter mais informações, consulte a seção link:../manage/enable-services.html["Habilitar serviços"].
* Adicione servidores vCenter à appliance ONTAP tools for VMware vSphere. Para mais informações, consulte a seção link:../configure/add-vcenter.html["Adicionar servidores vCenter"].
* Adicione backends de armazenamento às ONTAP tools for VMware vSphere. Para obter mais informações, consulte a link:../configure/add-storage-backend.html["Adicionar backends de armazenamento"] seção.
