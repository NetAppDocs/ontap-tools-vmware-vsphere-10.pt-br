...
summary: Mapeie os pools de recursos, hosts ou clusters entre os sites protegidos e de recuperação para posicionar as máquinas virtuais corretamente durante o failover. 
---
= Configure os mapeamentos de recursos nas ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Selecione *Preparar mapeamentos automaticamente para recursos com nomes correspondentes* e selecione *Avançar*.
...
.Resultado
A página Mapeamento de Recursos exibe os recursos do site protegido e os recursos do site de recuperação. Você pode seguir os mesmos passos para outros recursos em seu ambiente.
