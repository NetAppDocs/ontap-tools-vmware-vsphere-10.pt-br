...
sidebar: sidebar 
keywords: SRA configuration, Array Manager, VMware Live Site Recovery, SnapMirror, SVM interactions 
summary: Configure o SRA com o assistente VMware Live Site Recovery Array Manager para conectar sites protegidos e de recuperação a máquinas virtuais de storage. 
---
= Configure o SRA usando o gerenciador de arrays nas ferramentas ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
