...
. Adicione armazenamentos de dados à proteção do cluster de hosts seguindo link:../manage/edit-hostcluster-protection.html["Modificar cluster de host protegido"]. Adicione tipos de política assíncrona e síncrona.
