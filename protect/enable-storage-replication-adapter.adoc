...
sidebar: sidebar 
keywords: enable SRA, VMware Live Site Recovery, disaster recovery, SnapMirror schedules, ONTAP tools 
summary: Habilite o SRA em ONTAP tools para dar suporte aos fluxos de trabalho de recuperação de desastres do VMware Live Site Recovery. 
---
= Configure o SRA nas ONTAP tools para proteger datastores
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Antes de começar
* Você já deve ter configurado sua instância de servidor vCenter e os hosts ESXi.
...
.Passos
. Faça login na interface de gerenciamento do VMware Live Site Recovery appliance usando o URL: `\https://<srm_ip>:5480`, e então acesse Adaptadores de Replicação de Storage na interface de gerenciamento do VMware Live Site Recovery appliance.
