...
.. Clique no menu de elipses e selecione *Reset Configuration*
...
Depois de migrar de versões antigas das ferramentas do ONTAP para o VMware vSphere para o 10,3, volte a digitalizar os adaptadores SRA para verificar se os detalhes estão atualizados na página adaptadores de replicação de armazenamento de recuperação de site do VMware Live.
