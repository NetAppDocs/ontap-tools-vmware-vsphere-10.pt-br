...
---
= Notas de lançamento para ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Para obter uma lista completa dos novos recursos e melhorias, consulte xref:whats-new.adoc[Novidades nas ONTAP tools for VMware vSphere 10.5].
...
Para obter mais informações, consulte a  https://library.netapp.com/ecm/ecm_download_file/ECMLP3358876["Notas de versão das ONTAP tools for VMware vSphere 10.5"^]. Você precisa fazer login com sua NetApp account ou criar uma conta para acessar as Release Notes.
