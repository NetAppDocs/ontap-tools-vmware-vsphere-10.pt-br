...
---
= Conceitos e termos-chave nas ferramentas ONTAP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
vVols fornecem uma abstração em nível de volume para o armazenamento usado por uma máquina virtual. Inclui diversas vantagens e oferece uma alternativa ao uso de um LUN tradicional. Um datastore vVol é normalmente associado a um único LUN que atua como um contêiner para vVols.
