...
sidebar: sidebar 
keywords: ONTAP user roles and privileges, ONTAP tools JSON role file, storage backend least privilege, ONTAP System Manager roles 
summary: Configure as funções e privilégios de usuário para os backends de armazenamento com o arquivo JSON das ONTAP tools e ONTAP System Manager. 
---
