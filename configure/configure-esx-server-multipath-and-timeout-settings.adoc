...
summary: Configure o multipathing do host ESXi e as configurações de tempo limite do HBA para obter desempenho de storage NetApp ideal. 
---
= Configure as configurações do host ESXi nas ONTAP tools
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
