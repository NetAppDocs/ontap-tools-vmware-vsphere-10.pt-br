...
summary: Consulte o painel de ferramentas do ONTAP para ver um resumo do status do plug-in, dos datastores e dos dados do servidor vCenter. 
---
...
Se você adicionar um novo host a um cluster de hosts protegido, as configurações de proteção mudam para *Parcialmente protegido*.

Para resolver esse estado, abra *Modificar configuração do cluster*, atribua o host ao site correto (origem ou destino) e selecione *Modificar*.
