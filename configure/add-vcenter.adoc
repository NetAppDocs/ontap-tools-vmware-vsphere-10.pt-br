...
* Recomenda-se implantar o vCenter Server usando seu domínio totalmente qualificado (FQDN) e garantir que o SAN no certificado inclua DNS Name=machine_FQDN para compatibilidade e suporte ideais.
