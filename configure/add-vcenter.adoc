...
NOTE: Sem a conta de administrador, você pode criar uma função personalizada com permissões limitadas. link:../concepts/rbac-vcenter-use.html["Use o RBAC do vCenter Server com as ferramentas do ONTAP para VMware vSphere 10"]Consulte para obter detalhes.
