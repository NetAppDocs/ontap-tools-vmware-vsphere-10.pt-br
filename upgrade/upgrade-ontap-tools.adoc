...
** Na interface de usuário do gerenciador do sistema ONTAP, pesquise o volume pelo nome na barra de pesquisa e abra esse volume clicando no nome. Vá para snapshot e adicione o snapshot desse volume.
