...
[NOTE]
====
* Para sistemas ASA r2, certifique-se de atualizar ONTAP tools for VMware vSphere para 10.5 e ONTAP para 9.16.1 antes de configurar mais storage availability zones (SAZs).
