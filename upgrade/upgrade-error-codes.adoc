...
sidebar: sidebar 
keywords: upgrade error codes, ONTAP tools, VMware vSphere, troubleshooting, Ansible logs 
summary: Utilize os códigos de erro de atualização das ONTAP tools para identificar fluxos de trabalho com falha e solucionar problemas de atualização no VMware vSphere. 
---
...
| 068 | Falha ao reverter pacotes do sistema operacional Debian | Use a recuperação baseada em snapshot ou zero RPO e tente fazer a atualização novamente. 
...
| 074 | A montagem ISO falhou | Verifique o arquivo /var/log/otvng/upgrade-run.log e tente atualizar novamente. 
...
| 084 | Falha ao alterar o JobManager de volta à produção | Execute os seguintes passos para recuperar/concluir a atualização. 1. Habilite o Diagnostic Shell 2. Execute o comando: _sudo perl /home/maint/scripts/post-deploy-upgrade.pl --postupgrade_ 3. Verifique os logs em /var/log/otvng/post-deploy-upgrade.log 


| 087 | As etapas de pós-atualização falharam. | Execute os seguintes passos para recuperar/concluir a atualização. 1. Habilite o Diagnostic Shell 2. Execute o comando _sudo perl /home/maint/scripts/post-deploy-upgrade.pl --postupgrade_ 3. Verifique os logs em /var/log/otvng/post-deploy-upgrade.log 
...
| 098 | Falha ao copiar o segredo dockercred do namespace ntv-system para o namespace rook-ceph | Verifique os logs de atualização e tente atualizar novamente. 
...
| 090 | falha na validação do certificado para backends de armazenamento e vCenter | Verifique os registros de atualização e o arquivo de log em /var/log/otvng/cert_validation_error.log e tente a atualização novamente. 
